...
<body class="page">
    <div id="header">
        ...
        <div class="header-menu">
            <div class="header-menu-option" id="notifications" title="Not Implemented">
            ...
            <div class="header-menu-option" id="cart" title="Not Implemented">
            ...
            <div class="header-menu-option" id="profile" onclick="goToProfile()" th:onclick="goToProfile()" title="Profile">
            ...
            <div class="header-menu-option" id="sign-out" onclick="logout()" th:onclick="logout()" title="Logout">
